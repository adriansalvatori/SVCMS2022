...
final class TabAssignments extends Tab  {
	...
	public function render_assignments() {
        ...
        <input type='hidden'
               id="mdp-assignInput"
               name='<?php esc_attr_e( 'mdp_liker_' . self::TAB_SLUG . '_settings' ); ?>[assignments]'
                ...
                <div class="mdp-panel mdp-panel-box mdp-ips mdp-margin <?php $this->is_need_to_hide( 'ip_addresses' ); ?>">
                    ...
                    <div class="mdp-ips-box">
                        ...
                        <p>
                            ...
                            <?php esc_html_e( '46.33.233.31', 'liker' ); ?><br>
                            <?php esc_html_e( '46.0-46.1', 'liker' ); ?><br>
                            <?php esc_html_e( '46', 'liker' ); ?>
                        </p>
                    </div>
