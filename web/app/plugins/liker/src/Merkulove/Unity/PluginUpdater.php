...
final class PluginUpdater {
	...
	public function show_plugin_update_message( $plugin_data, $r ) {
		...
		if ( ! TabActivation::get_instance()->is_activated() ) {
            ...
            esc_attr_e( 'Your plugin license is ', 'liker' );
            echo '<strong style="color: #ff495c">';
            esc_attr_e( 'not activated', 'liker' );
            echo '.</strong> ';
            esc_attr_e( 'Please activate the license to receive automatic updates in one click, or visit the plugin page on the Envato market to ', 'liker' );
            echo ' <a href="https://1.envato.market/reviewer-elementor" target="_blank">';
			echo ' <a href="https://1.envato.market/liker" target="_blank">';
			esc_attr_e( 'download ', 'liker' );
			echo '</a> ';
			esc_attr_e( 'the latest version.', 'liker' );
		}
