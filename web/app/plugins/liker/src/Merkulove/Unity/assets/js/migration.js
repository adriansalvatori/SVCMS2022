...
"use strict";
/*!*******************************************************!*\
  !*** ./wp-content/plugins/liker/js/source/exp.js ***!
  \*******************************************************/
...
( function ( $ ) {
    ...
    $( document ).ready( function () {
        ...
        const { ajaxURL, nonce } = mdpLikerUnity;
            ...
            $exportButton.addEventListener('click', (e) => {
                ...
                xhr.onload = () => {
                    ...
                    if (xhr.status === 200) {
                        ...
                        // Download file
                        let fileName = 'liker-settings.json'
                ...
                xhr.send(`action=export_settings_liker&nonce=${nonce}`);
        ...
        function readFile( file ) {
            ...
            reader.onload = ( function( theFile ) {
                ...
                return function( e ) {
                    ...
                    xhr.send(`action=import_settings_liker&nonce=${ nonce }&import=${ encodeURIComponent( JSON.stringify( json ) ) }`);
