<?php
     ...
     */
    class FS_PH_EDD_Client_Migration_v2 extends FS_PH_Client_Migration_Abstract_v2 {
        /**
         *
         ...
         * @param FS_PH_Client_License_Abstract_v2 $edd_license_accessor         License accessor.
        ...
        public function __construct(
            ...
            $edd_store_url,
            $edd_download_id,
            FS_PH_Client_License_Abstract_v2 $edd_license_accessor,
            $migration_type = FS_PH_Client_Migration_Abstract_v2::TYPE_PRODUCT_TO_PRODUCT,
