<?php
     ...
     * @since    2.0.0
     *
     * Class FS_PH_Client_Addon_Migration_Abstract_v2
     */
    abstract class FS_PH_Client_Addon_Migration_Abstract_v2 {
        /**
         * @var string
         */
            ...
            if ( self::is_migration_on() ) {
                if ( ! $is_migration_debug ||
                    ...
                    // This should be replaced with your custom Freemius shortcode.
                        ...
                        // Migration type.
                        FS_PH_Client_Migration_Abstract_v2::TYPE_PRODUCT_TO_PRODUCT,
