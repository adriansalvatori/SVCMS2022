...
use ProjectHuddle\Vendor\Laminas\Code\DeclareStatement;
use ProjectHuddle\Vendor\Laminas\Code\Exception\InvalidArgumentException;
use ProjectHuddle\Vendor\Laminas\Code\Generator\Exception\ClassNotFoundException;
use Traversable;
