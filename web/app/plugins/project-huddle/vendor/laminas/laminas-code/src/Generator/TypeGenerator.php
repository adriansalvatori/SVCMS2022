...
use ProjectHuddle\Vendor\Laminas\Code\Generator\Exception\InvalidArgumentException;
use ProjectHuddle\Vendor\Laminas\Code\Generator\TypeGenerator\AtomicType;
use ReflectionClass;
...
final class TypeGenerator implements GeneratorInterface
{
     ...
     *                since the returned value does not include any root namespace ProjectHuddle\Vendor\prefixes, when applicable,
