...
use ProjectHuddle\Vendor\Psr\Http\Client\ClientExceptionInterface;
use ProjectHuddle\Vendor\Psr\Http\Client\ClientInterface;
use ProjectHuddle\Vendor\Psr\Http\Message\RequestFactoryInterface;
