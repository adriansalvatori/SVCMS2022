...
use ProjectHuddle\Vendor\Laminas\Math\Rand;
use ProjectHuddle\Vendor\Laminas\Session\Container as SessionContainer;
...
class Csrf extends AbstractValidator
{
    ...
    /**
     * Get session namespace ProjectHuddle\Vendor\for CSRF token
     *
     * Generates a session namespace ProjectHuddle\Vendor\based on salt, element name, and class.
     *
     * @return string
     */
