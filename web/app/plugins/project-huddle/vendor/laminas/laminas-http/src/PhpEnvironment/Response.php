...
namespace ProjectHuddle\Vendor\Laminas\Http\PhpEnvironment;

use ProjectHuddle\Vendor\Laminas\Http\Header\HeaderInterface;
use ProjectHuddle\Vendor\Laminas\Http\Header\MultipleHeaderInterface;
use ProjectHuddle\Vendor\Laminas\Http\Response as HttpResponse;
