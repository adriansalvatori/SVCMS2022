...
namespace ProjectHuddle\Vendor\Laminas\Uri;

use ProjectHuddle\Vendor\Laminas\Validator\EmailAddress as EmailValidator;
use ProjectHuddle\Vendor\Laminas\Validator\ValidatorInterface;
