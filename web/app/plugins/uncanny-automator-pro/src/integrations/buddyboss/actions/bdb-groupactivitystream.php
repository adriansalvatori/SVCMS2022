...
class BDB_GROUPACTIVITYSTREAM {
	...
	public function define_action() {
		...
		$action      = [
			...
			'options_group'      => [
				$this->action_meta => [
					$uncanny_automator->helpers->recipe->buddyboss->all_buddyboss_groups( null, $this->action_meta, $groups_argu ),
					$uncanny_automator->helpers->recipe->field->text_field( 'BDBACTION', esc_attr__( 'Activity action', 'uncanny-automator-pro' ), true, 'text', '', false ),
