...
class WPJM_JOBMARKFILLED {
	...
	public function __construct() {
		$this->trigger_code = 'WPJMJOBMARKFILLED';
	...
	public function define_trigger() {
		...
		$trigger = array(
			...
			'sentence'            => sprintf( esc_attr__( 'A user marks a {{specific type of:%1$s}} job as filled', 'uncanny-automator-pro' ), $this->trigger_meta ),
			/* translators: Logged-in trigger - WP Job Manager */
			'select_option_name'  => esc_attr__( 'A user marks a {{specific type of}} job as filled', 'uncanny-automator-pro' ),
