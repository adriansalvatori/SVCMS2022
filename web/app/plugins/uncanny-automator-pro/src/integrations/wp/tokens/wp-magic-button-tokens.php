...
class WP_Magic_Button_Tokens {
	...
	public function __construct() {
		...
		add_filter( 'automator_maybe_trigger_wp_wpmagicbutton_tokens', array( $this, 'wp_possible_tokens' ), 20, 2 );
	...
	public function wp_possible_tokens( $tokens = array(), $args = array() ) {
		...
		$fields = array(
			array(
				...
				'tokenName'       => __( 'Post ID', 'uncanny-automatmor' ),
				'tokenType'       => 'text',
				'tokenIdentifier' => $trigger_meta,
			),
			array(
				'tokenId'         => 'automator_button_post_title',
				'tokenName'       => __( 'Post title', 'uncanny-automatmor' ),
				'tokenType'       => 'text',
				'tokenIdentifier' => $trigger_meta,
			),
		);
