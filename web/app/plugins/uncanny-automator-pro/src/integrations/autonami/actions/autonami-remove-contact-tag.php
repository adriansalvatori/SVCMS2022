...
/**
 * Class AUTONAMI_REMOVE_CONTACT_TAG
 *
...
class AUTONAMI_REMOVE_CONTACT_TAG {
	...
	protected function setup_action() {
		...
		$this->set_action_code( 'REMOVE_CONTACT_TAG' );
		...
		$this->set_sentence( sprintf( esc_attr__( 'Remove {{a tag:%1$s}} from a contact', 'uncanny-automator' ), $this->get_action_meta() ) );
