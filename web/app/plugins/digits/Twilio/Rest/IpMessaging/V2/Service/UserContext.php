...
use Twilio\Options;
use Twilio\Rest\IpMessaging\V2\Service\User\UserBindingContext;
use Twilio\Rest\IpMessaging\V2\Service\User\UserBindingList;
use Twilio\Rest\IpMessaging\V2\Service\User\UserChannelContext;
 ...
 * @method UserChannelContext userChannels(string $channelSid)
 * @method UserBindingContext userBindings(string $sid)
 */
