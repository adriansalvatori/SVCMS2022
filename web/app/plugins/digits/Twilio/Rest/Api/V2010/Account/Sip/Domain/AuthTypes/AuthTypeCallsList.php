 ...
 * @method AuthCallsCredentialListMappingContext credentialListMappings(string $sid)
 * @method AuthCallsIpAccessControlListMappingContext ipAccessControlListMappings(string $sid)
 */
