export function moduleData() {
  return {
    ...
    computed: {
      allIcons() {
        let self = this;
        let masteroptions = self.options;
        let returndata = [];
        let temparray = [];
        let searchinput = self.thisSearchInput.toLowerCase();
    ...
    methods: {
      chosenicon(thicon) {
        this.chosenIcon = thicon;
        this.updateIcon(thicon);
      },
      removeIcon() {
        thicon = "removeicon";
        this.chosenIcon = "";
    ...
    template:
      '<div>\
        <div class="uip-flex uip-gap-xxs">\
          <span\
          class="material-icons-outlined uip-background-muted uip-padding-xs uip-border-round hover:uip-background-grey uip-cursor-pointer uip-margin-right-xs">{{chosenIcon}}</span>\
